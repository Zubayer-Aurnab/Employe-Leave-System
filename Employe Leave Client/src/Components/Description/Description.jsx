                ...
                <div className="px-4 lg:px-0  flex items-center flex-col lg:flex-row lg:mt-24">
                    <div className="pt-14 pb-36 flex-1 lg:pl-24">
                        ...
                        <ul className="list-disc list-inside text-lg mb-10 font-Montserrat font-medium ">
                            <li className='flex items-center gap-2'> <IoCheckmarkDoneCircleOutline /> Paid and unpaid leave status </li>
                            <li className='flex items-center gap-2 '> <IoCheckmarkDoneCircleOutline /> Setup different rules for different employees </li>
                            <li className='flex items-center gap-2'> <IoCheckmarkDoneCircleOutline />Track remote work </li>
